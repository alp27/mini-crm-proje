...
const options = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'Müşteri, Sipariş ve Ürün yönetimi için geliştirilmiş REST API.',
            contact: {
            ...
            schemas: {
                        ...
                        items: {
                            ...
                            items: {
                                ...
                                properties: {
                                    ...
                                    unitPrice: { type: 'number', example: 250.00 }
                                }
                            }
                        }
                    }
                ...
                Product: {
                    ...
                    properties: {
                        ...
                        sku: { type: 'string', description: 'Stok Tutma Kodu (Unique olmalı)', example: 'SMART-PHN-X' },
                        stock: { type: 'integer', example: 50 },
                        price: { type: 'number', format: 'float', example: 999.99 },
                        isStockTracking: { type: 'boolean', description: 'Stok takibi yapılıp yapılmayacağı', example: true }
                    }
                }
            }
        }
