...
async function createProduct(payload) {
    try {
        ...
        logger.info(`Product created: ${product.name} (SKU: ${product.sku}) - Stock: ${product.stock}`);
        return product;
    } catch (error) {
...
async function decreaseStock(productId, quantity) {
    try {
        ...
        if (product.stock < quantity) {
            logger.warn(`Insufficient Stock: SKU ${product.sku}. Current: ${product.stock}, Requested: ${quantity}`);
        ...
        logger.info(`Stock decreased: SKU ${product.sku}. New Stock: ${product.stock} (-${quantity})`);
        return product;
    } catch (error) {
